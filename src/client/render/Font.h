...
public:
    ...
    void buildWordWrap(RenderObjectBuilder& builder, float x, float y, int w, std::string text, Color color);
    inline void build(RenderObjectBuilder& builder, float x, float y, std::string text, Color color) {
