...
void Permission::initializeDefaultPermissions() {
    ...
    teleportPlayerCommand = new Permission("commands.default.tp", Permission::DefaultGrantTo::OPERATORS);
    ...
    defaultOperatorCommands->children.push_back(teleportPlayerCommand);
